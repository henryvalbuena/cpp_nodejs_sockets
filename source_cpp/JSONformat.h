...
namespace sict {
    ...
    // modify property, suppling property position in the array
        int updateProperty(const char* property_, size_t position_);
    // modify value, supplying property position in the array
        int updateValue(const char* value_, size_t position_);
    // remove property and value, supplying position in the array
